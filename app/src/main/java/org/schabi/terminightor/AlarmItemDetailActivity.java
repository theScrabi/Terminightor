 ...
 * AlarmItemDetailActivity.java is part of Terminightor.
 *
...
public class AlarmItemDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putString(AlarmItemDetailFragment.ARG_ITEM_ID,
                    getIntent().getStringExtra(AlarmItemDetailFragment.ARG_ITEM_ID));
            fragment = new AlarmItemDetailFragment();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            if(fragment.hasTag()) {
                fragment.updateItem();
                NavUtils.navigateUpTo(this, new Intent(this, AlarmItemListActivity.class));
            } else {
                fragment.noNfcTagSetDialog();
            }
            return true;
        }
